...
def solving(price_filename, traffic_filename,
...
market_hydrogen_cost=market_hydrogen_cost*30 # USD/MWHh
...
# In[64]:
H2E_List=[0.25,0.375,0.5,0.625,0.75]
E2H_List=[0.3,0.45,0.6,0.75,0.9]
#2022 FC
...
for i in range(len(H2E_List)):
    filename="sheets/results/"+"Revenue_AB_Sensitivity2022"+"FC"+str(H2E_List[i])+".csv"
    H2E=H2E_List[i]
    X[i,0]=solving(price_filename=price_filename, traffic_filename=traffic_filename
        ,Efficiency_H2E=H2E,Efficiency_E2H=Efficiency_E2H
        ,Delivery_Cost_Market_Hydrogen=0,Production_Cost_Market_Hydrogen=market_hydrogen_cost
...
price_filename=directory+'sheets/price/Alberta_Price_2022.csv'
traffic_filename=directory+'sheets/traffic/Alberta-Calgary-Northbound-2022-Randomized.csv'
for i in range(len(E2H_List)):
    filename="sheets/results/"+"Revenue_AB_Sensitivity2022"+"ELEC"+str(E2H_List[i])+".csv"
    E2H=E2H_List[i]
    X[i,1]=solving(price_filename=price_filename, traffic_filename=traffic_filename
        ,Efficiency_H2E=Efficiency_H2E,Efficiency_E2H=E2H
        ,Delivery_Cost_Market_Hydrogen=0,Production_Cost_Market_Hydrogen=market_hydrogen_cost
        ,Max_input_electrolyzer=Max_input_electrolyzer, Max_output_fuelcell=Max_output_fuelcell, number_of_vehicles=number_of_vehicles
        ,Max_hydrogen_tank=Max_hydrogen_tank
        ,filename=filename)
...
#2019 FC
price_filename=directory+'sheets/price/Alberta_Price_2019.csv'
traffic_filename=directory+'sheets/traffic/Alberta-Calgary-Northbound-2019-Randomized.csv'
Y=np.zeros((5,2))
for i in range(len(H2E_List)):
    filename="sheets/results/"+"Revenue_AB_Sensitivity2019"+"FC"+str(H2E_List[i])+".csv"
    H2E=H2E_List[i]
    Y[i,0]=solving(price_filename=price_filename, traffic_filename=traffic_filename
        ,Efficiency_H2E=H2E,Efficiency_E2H=Efficiency_E2H
        ,Delivery_Cost_Market_Hydrogen=0,Production_Cost_Market_Hydrogen=market_hydrogen_cost
        ,Max_input_electrolyzer=Max_input_electrolyzer, Max_output_fuelcell=Max_output_fuelcell, number_of_vehicles=number_of_vehicles
        ,Max_hydrogen_tank=Max_hydrogen_tank
...
traffic_filename=directory+'sheets/traffic/Alberta-Calgary-Northbound-2019-Randomized.csv'
for i in range(len(E2H_List)):
    filename="sheets/results/"+"Revenue_AB_Sensitivity2019"+"ELEC"+str(E2H_List[i])+".csv"
    E2H=E2H_List[i]
    Y[i,1]=solving(price_filename=price_filename, traffic_filename=traffic_filename
        ,Efficiency_H2E=Efficiency_H2E,Efficiency_E2H=E2H
        ,Delivery_Cost_Market_Hydrogen=0,Production_Cost_Market_Hydrogen=market_hydrogen_cost
        ,Max_input_electrolyzer=Max_input_electrolyzer, Max_output_fuelcell=Max_output_fuelcell, number_of_vehicles=number_of_vehicles
        ,Max_hydrogen_tank=Max_hydrogen_tank
...
print('2022 result: (FC,ELEC)',X)
print('2019 result: (FC,ELEC)',Y)
